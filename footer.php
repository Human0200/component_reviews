    ...
    <div class="container-fluid">
        <div class="footer__desc">
            ...
            <ul class="footer__requisites">
                ...
                <li>
                    <b>ИНН:</b> 480206344141
                </li>
                <li>
                    <b>ОГРНИП:</b> 321482700013249
                </li>
            </ul>
        </div>
        <nav class="footer__nav">
            <ul class="footer__nav-menu">
                <li>
                    <a class="footer__nav-link js-scrollto" href="/index.php/#solutions">Готовые решения</a>
                </li>
                <li>
                    <a class="footer__nav-link js-scrollto" href="/index.php/#individual">Индивидуальное внедрение</a>
                </li>
                <li>
                    <a class="footer__nav-link js-scrollto" href="/index.php/#cases">Кейсы</a>
                </li>
                <li>
                    <a class="footer__nav-link js-scrollto" href="/index.php/#about">О компании</a>
                </li>
            </ul>
            <ul class="footer__nav-social">
                <li>
                    <a class="footer__nav-link" href="https://wa.me/79675553444?text=">
                ...
                <li>
                    <a class="footer__nav-link" href="https://t.me/+79675553444">
                        <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <table class="footer__nav-contacts">
                <tr>
                    <td>
                        <a class="footer__nav-link" href="tel:+79675553444">+7 (967) 555-34-44</a>
                    </td>
                    <th>Номер</th>
                </tr>
                <tr>
                    <td>
                        <a class="footer__nav-link" href="mailto:info@3d-group.space">info@3d-group.space</a>
                    </td>
                    <th>Почта</th>
                </tr>
                <tr>
